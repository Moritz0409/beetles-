...
Tree_Plot_xylo <- ggarrange(plot1, plot2,  
...
Tree_Plot_red <- ggarrange(plot3, plot4,  
                           common.legend = TRUE, legend = "bottom",
                           ncol = 2, nrow = 1)
...
Tree_Plot_xylo_2018 <- ggarrange(plot9, plot10,  
                                 common.legend = TRUE, legend = "bottom",
                                 ncol = 2, nrow = 1)
...
Tree_Plot_red_2018 <- ggarrange(plot11, plot12,  
                                common.legend = TRUE, legend = "bottom",
                                ncol = 2, nrow = 1)
